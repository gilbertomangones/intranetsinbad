...
/**
 * @file
 * Contains \Drupal\reportes\Form\GenerarReportesEdadesForm.
 */
 ...
 */
class GenerarReportesEdadesForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'reportes_generarreportesedadesform'; //nombremodule_nombreformulario  
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $endpoint = "https://intranet.biblored.net/sinbad/json/actividad-poblacional?bib=".$bibli_sel.$sentencia_linea.$fecha_busqueda;
    //var_dump($endpoint);
    try {
      ...
      foreach ($track1 as $key => $value) {
        ...
        foreach ($value as $key2 => $value2) {
          ...
          foreach ($value2 as $key3 => $value3) {
             ...
             $sum_asistentes_61 += $value3['asistentes_61'];
