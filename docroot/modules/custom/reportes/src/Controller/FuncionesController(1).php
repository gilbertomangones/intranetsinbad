...
public function subprogramastable($programa){
    ...
    foreach ($subprogramas as $key => $value) {
      $output3[] = array('id'=> $key, 'progaccion'=> $value['progaccion'], 'nombre'=> $value['name'], 'ind_proceso' => $value['indicador_proceso'], 'ind_proceso_name' => $value['indicador_proceso_name'], 'ind_producto' => $value['indicador_producto'], 'ind_producto_name' => $value['indicador_producto_name']);
    }
