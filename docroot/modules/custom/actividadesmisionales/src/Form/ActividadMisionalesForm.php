...
namespace Drupal\actividadesmisionales\Form;
...
class ActividadMisionalesForm extends FormBase {

  public function getFormId() {
      return 'actividadesmisionales_actmisionalform'; //nombremodule_nombreformulario
    }
...
/*
  ...
  */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
      ...
      // Redirect to home
      $form_state->setRedirectUrl(Url::fromUri('internal:' . '/node/add/actividades_misionales', $params));
