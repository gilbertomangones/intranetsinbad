...
/**
* @file
* Contains Drupal\programacionform\form\ConcesionForm
*/
...
class ConcesionForm extends FormBase
{
  public function getFormId() {
    return 'biblored_module_concesionform'; //nombremodule_nombreformulario
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
   ...
   $form['table'] = array(
	...
	$header2 = array(
	  //'id' 		=> t('Id actividad'),
	  'name' 	=> t('Nombre de Programa'),
    'metas'  => t('Meta de proceso'),
    'publico' => t('Meta de producto'),
	);
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($values['table2'] as $key => $value) {
 	...
 	\Drupal::messenger()->addMessage(
           $newDateString. 'Metas de Programas o actividades guardadas para la concesión'
         );
  }
  ...
  $programas_habilitados = array();
    ...
    'metas' => array(
                  'data' => array(
                    ...
                    '#value' => 0,
                    '#size' => 10,
                    '#attributes' => array('class' => array('Meta de proceso')),
                    '#id' => 'metas-'.$valor,
                    '#name' => "metas[".$valor."]",
                  ),
                ),
    'publico' => array(
                  'data' => array(
                    ...
                    '#value' => 0,
                    '#size' => 10,
                    '#attributes' => array('class' => array('Meta de producto')),
                    '#id' => 'publico-'.$valor,
                    '#name' => "publico[".$valor."]",
                  ),
                ),
	 	 ); //PROGRAMAS PARA HABILITAR O PROGRAMAR EN LAS METAS DE LA CONCESIÓN
